...
function setup() {
	...
	rope1 = new Rope(bobObject1.body, roof.body, -35*0,0);
	rope2 = new Rope(bobObject2.body, roof.body, -35*0,0);
	rope3 = new Rope(bobObject3.body, roof.body, -35*0,0);
	rope4 = new Rope(bobObject4.body, roof.body, -35*0,0);
	rope5 = new Rope(bobObject5.body, roof.body, -35*0,0);
